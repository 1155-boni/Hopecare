...
class LibraryTests(TestCase):
    def setUp(self):
        self.student = User.objects.create_user(username='teststudent', password='testpass123', role='student', email='teststudent@example.com')
        self.welfare = User.objects.create_user(username='testwelfare', password='testpass123', role='welfare', email='testwelfare@example.com')
    ...
    # Removed test for StudentBookRecord creation as model was deleted
    ...
    def test_add_book_view(self):
        self.client.login(username='testwelfare', password='testpass123')
