"""
Django settings for hopecare_project project.
...
ROOT_URLCONF = 'hopecare_project.urls'
...
WSGI_APPLICATION = 'hopecare_project.wsgi.application'
...
CLOUDINARY_STORAGE = {
    'CLOUDINARY_URL': f"cloudinary://{os.getenv('CLOUDINARY_API_KEY')}:{os.getenv('CLOUDINARY_SECRET_KEY')}@{os.getenv('CLOUDINARY_NAME')}"
}
